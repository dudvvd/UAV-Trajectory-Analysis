...
class EKFLocalizer:
    ...
    def update_delta(self, delta_lon: float, delta_lat: float, delta_alt: float, confidence: float, dt: float) -> EKFState:
        """Fuse a visual delta as an absolute position observation after prediction."""
